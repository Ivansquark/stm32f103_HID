...
extern "C" void USB_HP_CAN_TX_IRQHandler() __attribute__((weak,alias("Default_Handler")));
extern "C" void USB_LP_CAN_RX0_IRQHandler() __attribute__((weak,alias("Default_Handler")));
...
void
__libc_fini_array (void)  //static destructors
{
  int count;
  int i;  
...
void __attribute__((naked,noreturn)) Reset_Handler()
{
    ...
    {*i=0;}    // set bss section memory cells to zero 
