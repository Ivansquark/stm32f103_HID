...
Reset_Handler:
	ldr   r0, =_estack		/*load from memory  in r0 address points*/
	mov   sp, r0          	/* set stack pointer */
	
	/*--------------------------------------------------------------*/
	/* Copy the data segment initializers from flash to SRAM */  
  	movs r1, #0         /*# - mean constant  in this case it is offset*/
  	b LoopCopyDataInit	/* b - mean branch - go to */
CopyDataInit:
  	ldr r3, =_sidata	/*in r3 .data address in flash*/	
  	ldr  r3, [r3, r1]   /*[] - address; in r3  r3+r1  next byte*/
  	str  r3, [r0, r1]	/* from r3 to address r0+(offset=r1) */
  	adds  r1, r1, #4	/*r1=r1+4	- offset=4*/
LoopCopyDataInit:
  	ldr  r0, =_sdata	
  	ldr  r3, =_edata
  	adds  r2, r0, r1	/*r2=r0+r1*/
  	cmp  r2, r3			/*compare r2 with r3  => if r2>=_edata exit LOOP*/
  	bcc  CopyDataInit   /*go to if cmp - adding for next 4 bytes*/
/*fill bss with zeros*/ 	  
  	ldr  r2, =_sbss
  	b  LoopFillZerobss
